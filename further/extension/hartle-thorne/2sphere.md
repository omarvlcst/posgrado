We take the line element of the Hartle-Thorne metric and write it in the approximated form to first order shown by Boshkayev, Quevedo & Ruffini (2014) for the solid angle of a 2-sphere of unit radius:
...
$$\phi'=\dfrac{d\phi}{d\theta}=\dfrac{C}{\sin\theta\mbox{ }\sqrt{\left(1-\dfrac{2GQ}{c^2}P_2(\cos\theta)\right)\sin^2\theta - C^2}} = \dfrac{C}{\sin\theta\mbox{ }\sqrt{\left(1-\dfrac{2GQ}{c^2}P_2(\cos\theta)\right)\sin^2\theta - C^2}} \dfrac{C}{\sin\theta\mbox{ }\sqrt{ 1 - q (-1 + 3 \cos^2(x)) \sin^2x  - C^2}}$$
